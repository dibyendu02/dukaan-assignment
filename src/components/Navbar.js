...
const Navbar = () => {
  return (
    <div className='flex w-full items-center justify-between px-5 py-3 bg-white sticky top-0 z-10 shadow-md'>
        ...
        <div className="w-[30%] px-4 py-[9px] bg-[#F2F2F2] space-x-2 flex items-center rounded-md">
            <CiSearch className='text-[#808080]' size={20}/>
        ...
        <div className='flex gap-2'>
            <div className='bg-[#E6E6E6] p-2.5 rounded-[50%]'>
